...
1. `docker build --platform linux/amd64 . -t registry.fly.io/anr-ggp-faucet:anr-ggp-faucet-v24`
2. `flyctl auth docker`
3. `docker push registry.fly.io/anr-ggp-faucet:anr-ggp-faucet-v24`
4. `flyctl deploy --app anr-ggp-faucet --image registry.fly.io/anr-ggp-faucet:anr-ggp-faucet-v24`
